...
Run the Azure Resource Graph queries from `queries/resource-graph/` to build a complete picture of the environment. Execute them in this order:
...
6. Name the output file: `assessment-{subscription-name}-{YYYY-MM-DD}.html`
