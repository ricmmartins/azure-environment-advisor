...
1. Check for multiple baseline files in `baselines/`
2. Use `scripts/generate-trend-dashboard.py` to produce a visual HTML trend page
3. The dashboard shows: score trends, finding counts by severity, pillar breakdown, recurring findings, and an executive summary
